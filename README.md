...
The required files to run this pipeline are included in the Part_2 folder in this repository (apart from the fastq files which are located on CLIMB).  
Reads are located here: https://jhub.climb.ac.uk/hub/user-redirect/lab/tree/shared-team/people/charlotte/task_2/reads

Some example results files are included but full results can be found on CLIMB.
